...
const ETF_REFERENCE_DATA: Record<string, {
  ...
  // ProShares Leveraged/Inverse ETFs
  ZSL: { underlyingAsset: 'Silver Futures', underlyingName: '-2x Daily Silver', category: 'Leveraged Inverse', issuer: 'ProShares', expenseRatio: 0.0095, holdings: 1 },
  AGQ: { underlyingAsset: 'Silver Futures', underlyingName: '2x Daily Silver', category: 'Leveraged', issuer: 'ProShares', expenseRatio: 0.0095, holdings: 1 },
  TQQQ: { category: 'Leveraged', issuer: 'ProShares', expenseRatio: 0.0088, holdings: 101 },
  SQQQ: { category: 'Leveraged Inverse', issuer: 'ProShares', expenseRatio: 0.0095, holdings: 101 },
  SPXU: { category: 'Leveraged Inverse', issuer: 'ProShares', expenseRatio: 0.0091, holdings: 503 },
  UPRO: { category: 'Leveraged', issuer: 'ProShares', expenseRatio: 0.0091, holdings: 503 },
  SOXL: { category: 'Leveraged', issuer: 'Direxion', expenseRatio: 0.0076, holdings: 30 },
  SOXS: { category: 'Leveraged Inverse', issuer: 'Direxion', expenseRatio: 0.0076, holdings: 30 },
  LABU: { category: 'Leveraged', issuer: 'Direxion', expenseRatio: 0.0075, holdings: 30 },
  LABD: { category: 'Leveraged Inverse', issuer: 'Direxion', expenseRatio: 0.0075, holdings: 30 },
  UVXY: { underlyingAsset: 'VIX Futures', underlyingName: '1.5x Daily VIX Short-Term', category: 'Volatility', issuer: 'ProShares', expenseRatio: 0.0095, holdings: 1 },
  SVXY: { underlyingAsset: 'VIX Futures', underlyingName: '-0.5x Daily VIX Short-Term', category: 'Volatility', issuer: 'ProShares', expenseRatio: 0.0095, holdings: 1 },
  SDS: { category: 'Leveraged Inverse', issuer: 'ProShares', expenseRatio: 0.0089, holdings: 503 },
  SSO: { category: 'Leveraged', issuer: 'ProShares', expenseRatio: 0.0089, holdings: 503 },
  QLD: { category: 'Leveraged', issuer: 'ProShares', expenseRatio: 0.0095, holdings: 101 },
  QID: { category: 'Leveraged Inverse', issuer: 'ProShares', expenseRatio: 0.0095, holdings: 101 },
  TNA: { category: 'Leveraged', issuer: 'Direxion', expenseRatio: 0.0095, holdings: 2000 },
  TZA: { category: 'Leveraged Inverse', issuer: 'Direxion', expenseRatio: 0.0095, holdings: 2000 },
  NUGT: { underlyingAsset: 'Gold Miners', underlyingName: '2x Daily Gold Miners', category: 'Leveraged', issuer: 'Direxion', expenseRatio: 0.0086, holdings: 50 },
  DUST: { underlyingAsset: 'Gold Miners', underlyingName: '-2x Daily Gold Miners', category: 'Leveraged Inverse', issuer: 'Direxion', expenseRatio: 0.0095, holdings: 50 },
  UDOW: { category: 'Leveraged', issuer: 'ProShares', expenseRatio: 0.0095, holdings: 30 },
  SDOW: { category: 'Leveraged Inverse', issuer: 'ProShares', expenseRatio: 0.0095, holdings: 30 },
  SH: { category: 'Inverse', issuer: 'ProShares', expenseRatio: 0.0089, holdings: 503 },
  PSQ: { category: 'Inverse', issuer: 'ProShares', expenseRatio: 0.0095, holdings: 101 },
  DOG: { category: 'Inverse', issuer: 'ProShares', expenseRatio: 0.0095, holdings: 30 },
  RWM: { category: 'Inverse', issuer: 'ProShares', expenseRatio: 0.0095, holdings: 2000 },
  TMF: { category: 'Leveraged', issuer: 'Direxion', expenseRatio: 0.0101, holdings: 40 },
  TMV: { category: 'Leveraged Inverse', issuer: 'Direxion', expenseRatio: 0.0093, holdings: 40 },
};
