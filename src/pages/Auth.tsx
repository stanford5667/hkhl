...
export default function Auth() {
  ...
  // Get the redirect path, requested mode and optional checkout intent from state
  ...
  // Honor mode changes coming from navigation (e.g. Log In vs Sign up free).
  useEffect(() => {
    if (locationState?.mode) setMode(locationState.mode);
  }, [locationState?.mode]);
