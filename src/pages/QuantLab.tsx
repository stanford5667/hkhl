...
import { CompactStudyCard } from '@/components/quant-lab/CompactStudyCard';
                ...
                {selectedStudies.map((studyId) => {
                  ...
                  return (
                    <CompactStudyCard
                      ...
                      result={result}
                      ticker={selectedTicker}
                      onSave={() => saveStudyResult(studyId)}
                      isSaving={isSaving === studyId}
                      onTickerClick={() => navigate(`/stock/${selectedTicker}`)}
                    />
                  );
                })}
              </div>
