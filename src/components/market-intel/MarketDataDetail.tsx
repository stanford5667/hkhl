...
const ASSET_EXPLANATIONS: Record<string, { description: string; factors: string[]; usage: string; tradingHours?: string; volatility?: string }> = {
  ...
  // Economic Indicators - Rates
  '10-Year Treasury': {
    description: 'The 10-Year US Treasury yield is the benchmark interest rate for the global financial system. It reflects market expectations for growth, inflation, and Fed policy over the next decade.',
    factors: ['Fed policy expectations', 'Inflation outlook', 'Economic growth', 'Flight to safety flows', 'Foreign demand (China, Japan)', 'Treasury supply/issuance', 'Term premium'],
    usage: 'Benchmark for mortgages, corporate bonds, and virtually all USD-denominated debt. Key input in equity valuation models.',
    tradingHours: 'Treasury market: 8:00 AM - 5:00 PM ET (cash), Futures trade nearly 24 hours',
    volatility: 'Medium - can move 10-20 basis points on major data releases',
  },
  'DGS10': {
    description: 'The 10-Year US Treasury yield is the benchmark interest rate for the global financial system. It reflects market expectations for growth, inflation, and Fed policy over the next decade.',
    factors: ['Fed policy expectations', 'Inflation outlook', 'Economic growth', 'Flight to safety flows', 'Foreign demand (China, Japan)', 'Treasury supply/issuance', 'Term premium'],
  ...
  '2-Year Treasury': {
    description: 'The 2-Year Treasury yield is the most sensitive to Federal Reserve policy expectations. It typically leads the Fed Funds rate and is a key indicator of near-term rate expectations.',
    factors: ['Fed funds rate expectations', 'FOMC forward guidance', 'Inflation data', 'Employment data', 'Short-term growth outlook'],
    usage: 'Proxy for Fed policy expectations, short-term corporate funding benchmark, yield curve analysis.',
    tradingHours: 'Treasury market: 8:00 AM - 5:00 PM ET',
    volatility: 'Medium-High - very sensitive to Fed communications',
  },
  'DGS2': {
    description: 'The 2-Year Treasury yield is the most sensitive to Federal Reserve policy expectations. It typically leads the Fed Funds rate and is a key indicator of near-term rate expectations.',
    factors: ['Fed funds rate expectations', 'FOMC forward guidance', 'Inflation data', 'Employment data', 'Short-term growth outlook'],
  ...
  'Fed Funds Rate': {
    description: 'The Federal Funds Rate is the interest rate at which banks lend reserve balances to other banks overnight. It\'s the Fed\'s primary policy tool and the foundation of US interest rates.',
    factors: ['FOMC decisions', 'Inflation vs 2% target', 'Employment conditions', 'Economic growth', 'Financial stability', 'Global central bank coordination'],
    usage: 'Foundation for all US interest rates. Directly influences prime rate, SOFR, and short-term borrowing costs.',
    tradingHours: 'Set by FOMC 8 times per year',
    volatility: 'Low between meetings - moves in 25bp increments',
  },
  'FEDFUNDS': {
    description: 'The Federal Funds Rate is the interest rate at which banks lend reserve balances to other banks overnight. It\'s the Fed\'s primary policy tool and the foundation of US interest rates.',
    factors: ['FOMC decisions', 'Inflation vs 2% target', 'Employment conditions', 'Economic growth', 'Financial stability', 'Global central bank coordination'],
  ...
  '30-Year Treasury': {
    description: 'The 30-Year Treasury yield (the "Long Bond") reflects ultra-long-term expectations for growth and inflation. It\'s key for pension funds and long-duration investors.',
    factors: ['Long-term inflation expectations', 'Demographic trends', 'Fiscal sustainability concerns', 'Pension/insurance demand', 'Foreign official holdings', 'Term premium'],
    usage: 'Long-term liability matching for pensions, insurance companies, and endowments. Mortgage rate benchmark.',
    tradingHours: 'Treasury market: 8:00 AM - 5:00 PM ET',
    volatility: 'Medium - less Fed-sensitive but reacts to fiscal concerns',
  },
  'DGS30': {
    description: 'The 30-Year Treasury yield (the "Long Bond") reflects ultra-long-term expectations for growth and inflation. It\'s key for pension funds and long-duration investors.',
    factors: ['Long-term inflation expectations', 'Demographic trends', 'Fiscal sustainability concerns', 'Pension/insurance demand', 'Foreign official holdings', 'Term premium'],
  ...
  'CPI': {
    description: 'The Consumer Price Index measures inflation as experienced by consumers. It\'s the most widely followed inflation measure, though the Fed officially targets Core PCE.',
    factors: ['Energy prices', 'Food prices', 'Shelter/rent costs', 'Used car prices', 'Medical costs', 'Wage growth', 'Supply chain conditions'],
    usage: 'Social Security adjustments (COLA), tax bracket adjustments, TIPS coupon calculations, Fed policy input.',
    tradingHours: 'Released monthly at 8:30 AM ET',
    volatility: 'High market impact - can move stocks 1-3% on surprises',
  },
  'CPIAUCSL': {
    description: 'The Consumer Price Index measures inflation as experienced by consumers. It\'s the most widely followed inflation measure, though the Fed officially targets Core PCE.',
    factors: ['Energy prices', 'Food prices', 'Shelter/rent costs', 'Used car prices', 'Medical costs', 'Wage growth', 'Supply chain conditions'],
  ...
  'Core PCE': {
    description: 'Core Personal Consumption Expenditures Price Index is the Fed\'s preferred inflation measure, excluding volatile food and energy. The Fed targets 2% Core PCE.',
    factors: ['Services inflation', 'Goods inflation', 'Housing costs', 'Healthcare costs', 'Wage growth pass-through', 'Import prices'],
    usage: 'Fed\'s primary inflation target. Key input for monetary policy decisions.',
    tradingHours: 'Released monthly at 8:30 AM ET (end of month)',
    volatility: 'High Fed relevance - shapes rate expectations',
  },
  // Economic Indicators - Employment
  'Unemployment Rate': {
    description: 'The unemployment rate measures the percentage of the labor force actively seeking work but unable to find employment. Part of the Fed\'s dual mandate.',
    factors: ['Job creation/destruction', 'Labor force participation', 'Discouraged workers', 'Demographic shifts', 'Structural vs cyclical factors'],
    usage: 'Fed policy input, recession indicator, consumer confidence proxy.',
    tradingHours: 'Released first Friday of month at 8:30 AM ET',
    volatility: 'High - part of the most-watched economic release (Employment Situation)',
  },
  'UNRATE': {
    description: 'The unemployment rate measures the percentage of the labor force actively seeking work but unable to find employment. Part of the Fed\'s dual mandate.',
    factors: ['Job creation/destruction', 'Labor force participation', 'Discouraged workers', 'Demographic shifts', 'Structural vs cyclical factors'],
  ...
  'GDP': {
    description: 'Gross Domestic Product measures the total value of goods and services produced in the economy. The definitive measure of economic growth.',
    factors: ['Consumer spending (70%)', 'Business investment', 'Government spending', 'Net exports', 'Inventory changes'],
    usage: 'Recession definition (2 consecutive negative quarters), fiscal policy input, corporate planning.',
    tradingHours: 'Released quarterly (~30, 60, 90 days after quarter end)',
    volatility: 'Moderate - often priced in from monthly indicators',
  },
  'GDPC1': {
    description: 'Gross Domestic Product measures the total value of goods and services produced in the economy. The definitive measure of economic growth.',
    factors: ['Consumer spending (70%)', 'Business investment', 'Government spending', 'Net exports', 'Inventory changes'],
  ...
  // Market Indicators
  'VIX': {
    description: 'The CBOE Volatility Index measures implied volatility of S&P 500 options. Known as the "Fear Index," it spikes during market stress and falls during complacency.',
    factors: ['Market uncertainty', 'Options demand', 'Hedging activity', 'Macro risks', 'Correlation dynamics', 'Term structure'],
    usage: 'Risk management, portfolio hedging, market sentiment gauge, volatility trading.',
    tradingHours: 'Continuous during market hours, VIX futures trade nearly 24 hours',
    volatility: 'Very High - can double in days during crises',
  },
  'VIXCLS': {
    description: 'The CBOE Volatility Index measures implied volatility of S&P 500 options. Known as the "Fear Index," it spikes during market stress and falls during complacency.',
    factors: ['Market uncertainty', 'Options demand', 'Hedging activity', 'Macro risks', 'Correlation dynamics', 'Term structure'],
  ...
  'S&P 500': {
    description: 'The S&P 500 is a market-cap weighted index of 500 large US companies, representing ~80% of US equity market cap. The primary benchmark for US equity performance.',
    factors: ['Corporate earnings', 'Interest rates', 'Economic growth', 'Sector rotation', 'Valuation multiples', 'Investor sentiment', 'Liquidity'],
    usage: 'Primary equity benchmark, passive investing, derivatives/options trading, portfolio allocation.',
    tradingHours: '9:30 AM - 4:00 PM ET (cash), Futures trade nearly 24 hours',
    volatility: 'Medium - ~15-20% annual volatility historically',
  },
  'SP500': {
    description: 'The S&P 500 is a market-cap weighted index of 500 large US companies, representing ~80% of US equity market cap. The primary benchmark for US equity performance.',
    factors: ['Corporate earnings', 'Interest rates', 'Economic growth', 'Sector rotation', 'Valuation multiples', 'Investor sentiment', 'Liquidity'],
