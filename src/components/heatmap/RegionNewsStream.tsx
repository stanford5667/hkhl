              ...
              {events.map((event) => {
                ...
                return (
                  <motion.button
                    ...
                    className="w-full text-left flex gap-2.5 px-2.5 py-2 rounded-lg hover:bg-muted/40 transition-colors group cursor-pointer"
                  >
                    ...
                    <div className="flex-1 min-w-0 space-y-1">
                      <div className="flex items-start justify-between gap-1.5">
                        <p className="text-xs font-medium leading-snug line-clamp-2 text-foreground/90 group-hover:text-primary transition-colors">
                          {event.title}
                        </p>
