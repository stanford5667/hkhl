...
export const FINANCIAL_TERMS: Record<string, TermDefinition> = {
  ...
  'expected-return': {
    ...
    icon: 'TrendingUp',
    color: '#3b82f6',
    shortDescription: 'The anticipated annual percentage gain from your portfolio.',
    fullDescription: 'Expected return is the annualized percentage gain you can anticipate from your portfolio based on your asset allocation and historical performance of similar portfolios. It represents the probability-weighted average of all possible returns.',
  ...
  'max-drawdown': {
    ...
    fullDescription: 'Maximum drawdown measures the worst decline from a portfolio peak to a subsequent trough before a new peak is reached. It represents the worst-case loss scenario you should be psychologically and financially prepared for.',
    whyItMatters: 'This is your stress test. If you can\'t emotionally handle seeing your portfolio drop by this amount, you\'ll likely panic sell at the worst time. Know your limits.',
    howToUse: 'Ask yourself: "If my portfolio dropped X%, would I sell everything?" If yes, reduce risk until your max drawdown is within your tolerance.',
    keyPoints: [
