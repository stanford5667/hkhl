                ...
                <td className="absolute inset-0 z-20 opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-all duration-250" style={{ position: 'absolute' }}>
                  <div className="flex items-center justify-center gap-2.5 h-full bg-black/60 backdrop-blur-sm" onClick={(e) => e.stopPropagation()}>
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 font-mono font-semibold text-xs px-4 py-2 rounded-full bg-white/10 text-white border border-white/20 hover:bg-white/20 hover:border-white/30 transition-all backdrop-blur-sm"
                    >
                      📊 Research
                    </button>
                    <button
                      onClick={(e) => { e.stopPropagation(); e.preventDefault(); navigate(`/stock/${earning.symbol}`, { state: { tab: 'backtest' } }); }}
                      className="inline-flex items-center gap-1.5 font-mono font-semibold text-xs px-4 py-2 rounded-full bg-[hsl(175_80%_45%)] text-background hover:bg-[hsl(175_80%_50%)] shadow-[0_0_16px_hsl(175_80%_45%/0.5)] hover:shadow-[0_0_24px_hsl(175_80%_45%/0.7)] transition-all"
                    >
                      ⚡ Quick Test
                    </button>
                  </div>
